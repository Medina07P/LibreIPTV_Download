<div align="center">
  ...
  **Tu contenido IPTV en Android TV y móvil, sin complicaciones.**
  ...
  ![Versión](https://img.shields.io/badge/versión-1.6.3-blue?style=flat-square)
...
|---|---|---|
| **Android móvil** (teléfono / tablet) | `LibreIPTV-1.6.3.apk` | [⬇️ Descargar última versión](https://github.com/Medina07P/LibreIPTV_Download/releases/latest) |
| **Android TV / Google TV / Fire TV** | `LibreIPTV-1.6.3.apk` | [⬇️ Descargar última versión](https://github.com/Medina07P/LibreIPTV_Download/releases/latest) |
...
adb install LibreIPTV-1.6.3.apk
```
