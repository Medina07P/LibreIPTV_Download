...
|---|---|---|
| **Android móvil** (teléfono / tablet) | `LibreIPTV-1.1.0.apk` | [⬇️ Descargar última versión](https://github.com/Medina07P/LibreIPTV_Download/releases/latest) |
| **Android TV / Google TV / Fire TV** | `LibreIPTV-1.1.0.apk` | [⬇️ Descargar última versión](https://github.com/Medina07P/LibreIPTV_Download/releases/latest) |
...
adb install LibreIPTV-1.1.0.apk
```
